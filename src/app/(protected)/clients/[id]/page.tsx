        ...
        {editingClient ? (
          ...
          <div className="flex items-start justify-between">
            ...
            <button
              ...
              className="text-sm px-3 py-1 rounded-lg cursor-pointer transition-colors duration-200"
              style={{
                color: "var(--color-text-muted)",
                border: "1px solid var(--color-border-light)",
              }}
              ...
              <table className="w-full text-sm table-fixed">
                <thead style={{ background: "var(--color-bg)" }}>
                  ...
                  >
                    ...
                    <th className="text-right py-3 px-3 w-[140px]">מוצר/קרם</th>
              ...
              {treatments.map((treatment) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-y-2 gap-x-3 text-sm">
                    ...
                    <div className="text-left ltr">{new Date(treatment.date + "T00:00:00").toLocaleDateString("he-IL")}</div>
                    ...
                    <div style={{ color: "var(--color-text-muted)" }}>מחיר</div>
